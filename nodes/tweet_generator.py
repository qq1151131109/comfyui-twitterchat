...
示例（参考风格）:
"A woman alone in a traditional Chinese tea room. Wearing an exquisite light blue qipao with delicate floral embroidery, paired with traditional cloth shoes. She is sitting gracefully on a wooden chair, hands resting on the tea table, preparing tea with focused expression. Soft afternoon sunlight streams through the paper window, creating warm golden tones and gentle shadows on the wooden floor. The atmosphere is peaceful and refined. Background shows traditional wooden furniture, hanging calligraphy scrolls on the wall, ceramic tea sets arranged on antique shelves, and a small bonsai tree by the window. Medium shot, slight side angle, shallow depth of field focusing on her hands and the teaware, cinematic lighting, warm color grading, 8k quality."
