...
# New Persona Generation Pipeline nodes
from .nodes import PERSONA_NODE_CLASS_MAPPINGS, PERSONA_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(PERSONA_NODE_CLASS_MAPPINGS)  # Add persona pipeline nodes
...
NODE_DISPLAY_NAME_MAPPINGS.update(PERSONA_NODE_DISPLAY_NAME_MAPPINGS)  # Add persona pipeline display names
